...
*/
contract PBWallet is ITONTokenWallet, IDestroyable, IBurnableByOwnerTokenWallet, IBurnableByRootTokenWallet, IVersioned {
...
*/
    function claimTiles(address gameAddress) external onlyInternalOwner {
